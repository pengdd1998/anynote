      ...
      children: [
        ...
        StaggeredGroup(
          ...
          child: Column(
            ...
            mainAxisSize: MainAxisSize.min,
            children: [
              SettingsGroupHeader(title: l10n.sourceHeader),
              SettingsGroup(
                children: [
                  SettingsItem(
      ...
      children: [
        StaggeredGroup(
          ...
          child: Column(
            ...
            mainAxisSize: MainAxisSize.min,
            children: [
              SettingsGroupHeader(title: l10n.appleNotesExportHeader),
              SettingsGroup(
                children: [
                  Padding(
                    padding: const EdgeInsets.all(16),
                    child: Text(
                      l10n.appleNotesImportDesc,
                      style: theme.textTheme.bodySmall?.copyWith(
                        color: theme.textTheme.bodySmall?.color,
                      ),
                    ),
      ...
      children: [
        StaggeredGroup(
          ...
          child: Column(
            ...
            mainAxisSize: MainAxisSize.min,
            children: [
              SettingsGroupHeader(title: l10n.plainTextFilesHeader),
              SettingsGroup(
                children: [
                  Padding(
                    padding: const EdgeInsets.all(16),
                    child: Text(
                      l10n.plainTextImportDesc,
                      style: theme.textTheme.bodySmall?.copyWith(
                        color: theme.textTheme.bodySmall?.color,
                      ),
                    ),
              ...
              if (result.hasErrors) ...[
                ...
                if (result.errors.length > 5)
                  Padding(
                    ...
                    child: Text(
                      l10n.andMoreErrors(result.errors.length - 5),
                      style: theme.textTheme.bodySmall?.copyWith(
